...
public class ConsoleInterfaceUser implements InterfaceUser {
    ...
    public ConsoleInterfaceUser(FamilyTree familyTree, Scanner in) {
    ...
    public void menu() {
        ...
        switch (number){
            ...
            case 4:
                ...
                break;
            case 5:
                fileWorker.save(familyTree);
                break;
            case 6:
                this.familyTree = fileWorker.read();
                break;
            case 7:
                System.out.println(familyTree);
                break;
